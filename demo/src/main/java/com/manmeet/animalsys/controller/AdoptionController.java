...
public class AdoptionController {
	...
	public String submitAdoptionRequest(@PathVariable Long animalId, RedirectAttributes redirectAttributes,
		...
		String userSubject = "Adoption Request Submitted";
		String userBody = String.format("Dear %s,\n\nThank you for your interest in adopting! "
				+ "We have received your adoption request for the animal '%s' and it is currently pending review."
				+ "We appreciate your commitment to providing a loving home."
				+ "\n\nOur team will review your request and get back to you shortly. "
				+ "If you have any questions in the meantime, please do not hesitate to reach out."
				+ "\n\nBest regards,\nAnimal Welfare Team", currentUser.getName(), animal.getName());

		notificationService.sendEmail(currentUser.getEmail(), userSubject, userBody);
		...
		String adminSubject = "New Adoption Request Pending Review";
		String adminBody = String.format(
				"Dear Admin,\n\nA new adoption request has been submitted by %s for the animal '%s'. "
						+ "Please review the request at your earliest convenience."
						+ "\n\nAdoption Request Details:\n- User: %s\n- Animal: %s\n- Status: Pending"
						+ "\n\nThank you for your attention to this matter." + "\n\nBest regards,\nAnimal Welfare Team",
				currentUser.getName(), animal.getName(), currentUser.getName(), animal.getName());
	...
	@PreAuthorize("hasRole('ADMIN')")
	public String updateAdoptionRequestStatus(@RequestParam Long requestId, @RequestParam String decision) {
		...
		if (adoptionRequest != null) {
			...
			throw new EntityNotFoundException("Adoption request not found."); // Ensure this exception is handled
																				// appropriately
		}
